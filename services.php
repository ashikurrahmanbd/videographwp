...
?>
    ...
    <section class="callto sp__callto">
        <div class="container">
            <div class="callto__services spad set-bg" data-setbg="<?php echo get_template_directory_uri(); ?>/img/calltos-bg.jpg">
    ...
    <div class="logo spad">
        <div class="container">
            <div class="logo__carousel owl-carousel">
                <a href="#" class="logo__item"><img src="<?php echo get_template_directory_uri(); ?>/img/logo/logo-1.png" alt=""></a>
                <a href="#" class="logo__item"><img src="<?php echo get_template_directory_uri(); ?>/img/logo/logo-2.png" alt=""></a>
                <a href="#" class="logo__item"><img src="<?php echo get_template_directory_uri(); ?>/img/logo/logo-3.png" alt=""></a>
                <a href="#" class="logo__item"><img src="<?php echo get_template_directory_uri(); ?>/img/logo/logo-4.png" alt=""></a>
                <a href="#" class="logo__item"><img src="<?php echo get_template_directory_uri(); ?>/img/logo/logo-5.png" alt=""></a>
                <a href="#" class="logo__item"><img src="<?php echo get_template_directory_uri(); ?>/img/logo/logo-6.png" alt=""></a>
            </div>
        </div>
    </div>
    <!-- Logo End -->
